...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class AboutController : Controller
    {
        ...
        public async Task<IActionResult> CreateAbout(CreateAboutDto createAboutDto)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(createAboutDto); //Json formatına çevirdik.
            ...
            var responseMessage = await client.PostAsync("https://localhost:7070/api/Abouts", stringContent); //İlgili adrese istekte bulunabilmek için responseMessage değişkenine atadık.
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "About", new { area = "Admin" }); //İşlem başarılıysa Index sayfasına yönlendir. İkinci parametre controller adı, üçüncü parametre ise area adıdır.
            }
            return View();
        }
