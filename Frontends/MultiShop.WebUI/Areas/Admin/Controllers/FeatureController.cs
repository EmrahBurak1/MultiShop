...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class FeatureController : Controller
    {
        ...
        public async Task<IActionResult> CreateFeature(CreateFeatureDto createFeatureDto)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(createFeatureDto); //Json formatına çevirdik.
            ...
            var responseMessage = await client.PostAsync("https://localhost:7070/api/Features", stringContent); //İlgili adrese istekte bulunabilmek için responseMessage değişkenine atadık.
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "Feature", new { area = "Admin" }); //İşlem başarılıysa Index sayfasına yönlendir. İkinci parametre controller adı, üçüncü parametre ise area adıdır.
            }
            return View();
        }
